'''Reimplement from_pretrained in RobertaForSequenceClassification since the origin from_pretrained method can not load ensemble model.'''
...
class PreTrainedModel(nn.Module, ModuleUtilsMixin):
    ...
    def _generate_beam_search(
        ...
        decoded = input_ids.new(
            batch_size, tgt_len.max().item()).fill_(pad_token_id)
...
class RobertaForSequenceClassificationNew(RobertaForSequenceClassification):
    @classmethod
